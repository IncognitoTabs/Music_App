			...
			<nav class="navbar navbar-expand-lg">
				<div class="folder-list_header collapse navbar-collapse"
					...
					<form class="d-flex login-btn ">
						<a href="./pages/login.jsp" class="btn" type="submit">Login</a> <a
							href="./pages/ConfirmUser.jsp" class="btn" type="submit">Register</a>
					</form>
					<div class="dropdown none-btn">
						<button class="btn btn-secondary dropdown-toggle border-radius"
							type="button" data-bs-toggle="dropdown" aria-expanded="false"
							name="show_name">${show_name}</button>
