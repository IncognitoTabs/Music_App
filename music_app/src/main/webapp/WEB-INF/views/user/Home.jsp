...
<body>
	...
	<div class="container-fluid">
		<div class="main">
			<div class="row">
				<div class="menu-bar list-music-item col-2">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link"
							href="./search-page.html"> <i
								class="fa-solid fa-magnifying-glass"></i> Search
						</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./music-category.html"> <i
								class="bi bi-music-note-list margin-top"></i> My library
						</a></li>
					</ul>
				...
				<div class="container__info col-10">
					...
					<div class="container__info-list">
							...
							<!-- <div class="list-item" >
                                ...
                                <div class="list__title">
                                    ...
                                    <div class="list__title-song">
                                        <a href="" class="list__title-link-song"><span>Lối nhỏ</span> </a>
                                    </div>
                                    <div class="list__title-singer">
                                        <a href="" class="list__title-link-singer"><span>Đen Vâu</span></a>
                                    </div>
                                    </div>
                                </div>
                                <div class="list__album">
                                    <a href="" class="list__album-name"><span>Lộn xộn 3</span></a>
                                </div>
                                <div class="list__dateAdd">
                                    <p class="list__dateAdd-date">6 phút trước</p>
                                </div>
                                <div class="list__time">
                                    <p class="list__time-time-song">3:10</p>
                                </div>
                            </div> -->
						...
						<div class="see-more">
							...
							<!-- <a href="" class="none-btn">SHOW LESS</a>   -->
						</div>
					</div>
				</div>
